...
public abstract class Wallet {
    ...
    protected List<Money> generateMoney( final long amout, final String description) {
    ...
    public String toString() {
        long cents = getBalance();
        long reais = cents / 100;
        long rem = cents % 100;
        return "Wallet{service=" + service + ", money= R$" + reais + "." + String.format("%02d", rem) + "}";
    }
}
